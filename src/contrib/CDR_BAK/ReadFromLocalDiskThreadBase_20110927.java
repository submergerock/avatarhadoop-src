...
public  abstract class ReadFromLocalDiskThreadBase_20110927<T> implements Runnable {
	...
	public ReadFromLocalDiskThreadBase_20110927(Integer condition) {
		this.condition = condition;
	}

	public static boolean ThreadsIsOver(ArrayList<? extends ReadFromLocalDiskThreadBase_20110927> list) {
