...
//    setStartCheckpointTime(conf);
 ...
 // if we are starting as the standby then
    ...
    if (instance == InstanceId.NODEONE) {
      //add by wzt 2013-0401
      LOG.info("wzt avatarnode ONE:primary="+primary+" standby="+standby);
      //end add
      ...
      destedit = new File(edit1);
        ...
        //add by wzt 2013-0401
        LOG.info("wzt avatarnode ZERO:primary="+primary+" standby="+standby);
        //end add
    ...
    if (src.exists() && syncAtStartup) {
      //add by wzt 2013-0401
      LOG.info("wzt avatarnode sync startup");	
      //end add
      ...
      lockfile.delete();
      //add by wzt 2013-0401
      LOG.info("wzt avatarnode:"+dest+" "+STORAGE_FILE_LOCK+" delete");
      //end add
      ...
      ckptfile.delete();
      //add by wzt 2013-0401
      LOG.info("wzt avatarnode:"+dest+" "+IMAGENEW+" delete");
      //end add
    ...
    if (srcedit.exists() && syncAtStartup) {
      ...
      //add by wzt 2013-0401
      LOG.info("wzt avatarnode edit "+destedit+" "+EDITSFILE+" delete ,editnew "+destedit+" "+EDITSNEW+" create edit "+destedit);
      //end add
