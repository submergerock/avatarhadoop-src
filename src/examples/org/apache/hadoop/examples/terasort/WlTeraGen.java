 ...
 */
public class WlTeraGen extends Configured implements Tool {
  ...
  public int run(String[] args) throws IOException {
    ...
    job.setJobName("WlTeraGen");
    job.setJarByClass(WlTeraGen.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    int res = ToolRunner.run(new JobConf(), new WlTeraGen(), args);
    System.exit(res);
  }
