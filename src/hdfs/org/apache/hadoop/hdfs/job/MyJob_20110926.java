...
public class MyJob_20110926  implements Runnable{

  public static final Log LOG = LogFactory.getLog(MyJob_20110926.class.getName());
...
//	  }
	  ...
	  LOG.info("j.getJobId() : " + j.getJobId());
  		if(this.jobIdtoRunJob.get(j.getJobName()) == null){
	        ...
	        = j.getConf().getClass("hdfs.job.class",null, JobProtocol.class);
  	  	  ...
  	  	  this.jobIdtoRunJob.put(j.getJobName().toString(), jobClasstoRunJob);
  		} else {  
  		  //LOG.info("+++++MyJob.runJob(Job j)+++++222");
  		  HashMap<Class<? extends JobProtocol>,RunJob> jobClasstoRunJob = jobIdtoRunJob.get(j.getJobName().toString());
