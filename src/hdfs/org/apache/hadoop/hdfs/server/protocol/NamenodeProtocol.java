...
public interface NamenodeProtocol extends VersionedProtocol {
  ...
  /**
   * Sets the block of recoverFile to srcFile.
   * @param srcFile Missing block file .
   * @param recoverFile This file only contains one block.
   * @param blockIndexNo The missing block index of srcFile .
   */
