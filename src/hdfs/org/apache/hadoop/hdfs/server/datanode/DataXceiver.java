...
class DataXceiver implements Runnable, FSConstants {
  ...
  public DataXceiver(Socket s, DataNode datanode, 
    ...
    //dataXceiverServer.childSockets.put(s, s); //update by wzt 2012-12-09
    remoteAddress = s.getRemoteSocketAddress().toString();
    localAddress = s.getLocalSocketAddress().toString();
    LOG.info("Number of active connections is: " + datanode.getXceiverCount());
  }
  ...
  public void run() {
    ...
    dataXceiverServer.childSockets.put(s, s); //add by wzt 2012-12-09
    try {
      //s.setSoTimeout(datanode.socketTimeout*10);//add by wzt 2012-12-09	
      ...
      //update by wzt 2012-12-09
      LOG.info("wzt debuginfo:xceiverCount " + curXceiverCount+" sysconfig xceiverCount is "+dataXceiverServer.maxXceiverCount);
    ...
    }catch(OutOfMemoryError oOM){//add by wzt
    	LOG.error("DataXceiver outofmemory,show System.gc() ",oOM);
    	System.gc();
    	try{
    		Thread.sleep(30*1000);
    	}catch(Exception ie){}
    }catch (Throwable t) {
      LOG.error("wzt debuginfo: this socket close!!! Throwable "+datanode.dnRegistration + ":DataXceiver",t);
    } finally {
      LOG.info(datanode.dnRegistration + ":Number of active connections is: "
