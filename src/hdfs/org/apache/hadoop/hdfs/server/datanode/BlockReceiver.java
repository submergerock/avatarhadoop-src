...
class BlockReceiver implements java.io.Closeable, FSConstants {
  ...
  BlockReceiver(Block block, DataInputStream in, String inAddr,
    ...
    try{
      ...
      // Open local disk out
      //
      streams = datanode.data.writeToBlock(block, isRecovery, clientName == null || clientName.length() == 0);//-----change by wanglei 2011.11.30.01
...
//    flush();
  ...
  void receiveBlock(
    ...
    try {
       ...
       */
      //LOG.info("******before receivePacket!!!******");
      while (receivePacket() > 0) {}
      //LOG.info("******after receivePacket!!!******");
