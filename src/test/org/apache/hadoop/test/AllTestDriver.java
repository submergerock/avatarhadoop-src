...
import org.apache.hadoop.hdfs.DirUpload2Hdfs;
import org.apache.hadoop.hdfs.NNBench;
import org.apache.hadoop.hdfs.NNBenchTestLock;
...
public class AllTestDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      ...
      pgd.addClass("dirupload2hdfs", DirUpload2Hdfs.class, "local dir upload hdfs inbasedir=localdir prefix datadir=hdfsdir");
      pgd.addClass("nnbenchlock", NNBenchTestLock.class, "nnbench lock");
