...
public class DF extends Shell {
  ...
  public static long getReservedSpace(File path, Configuration conf) {
    ...
    return Math.max(reservedBytes, (long) (path.getTotalSpace()*(reservedPercent / 100.0)));
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    //conf.setLong("dfs.datanode.du.reserved", 8000000000L);
    //conf.setFloat("dfs.datanode.du.reserved.percent", 0.5f);
