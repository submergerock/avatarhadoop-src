...
public abstract class Server {
  ...
  private class Connection {
    ...
    private void putCall(int callID,Call call) throws InterruptedException{
    	...
    	callIDCount++;
    	//if(callIDCount % 8 == 0){
    	//	LOG.info("wzt testinfo rpcserver:"+ index +"  callqueue put callid:"+call.id+" callIDCount:"+callIDCount);
    	//}
    }
    //end by
  ...
  private class Handler extends Thread {
	private long callIDCount = 0;//add by wzt 2013-0125
    ...
    private Call takeCall() throws InterruptedException{
    	Call call = callQueueArray[this.threadID].take();
    	callIDCount++;
    	//if(callIDCount % 8 == 0){
    	//	LOG.info("wzt testinfo rpcserver: "+this.threadID +" handlerthread take callid:"+call.id+" callIDCount:"+callIDCount);
    	//}
