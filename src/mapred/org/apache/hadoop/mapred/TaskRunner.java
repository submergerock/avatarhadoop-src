...
abstract class TaskRunner extends Thread {
  ...
  public final void run() {
    try {
      ...
      LOG.info("wzt debuginfo:javaOpts:"+javaOpts);
      ...
      if (ulimitCmd != null) {
        ...
        for (String arg : ulimitCmd) {
          //add by wzt 2012-01-16
          LOG.info("wzt debuginfo:ulimitCmd: "+arg);
          //end add
          setup.add(arg);
        }
      }
      ...
      //add by wzt 2013-01-16
      LOG.info("wzt debuginfo:jvmManager env:"+env);
      //end add
      synchronized (lock) {
        while (!done) {
          lock.wait();
