 ...
 */
public class JTAddress implements WritableComparable<JTAddress> {
   ...
   */
  public JTAddress(String hostAndPort) {
   ...
   */
  public JTAddress(String bindAddress, int port) {
   ...
   */
  public JTAddress(JTAddress other) {
  ...
  public String getBindAddress() {
    ...
    if (addr != null) {
      ...
      LogFactory.getLog(JTAddress.class).error("Could not resolve the"
  ...
  public boolean equals(Object o) {
    ...
    return compareTo((JTAddress) o) == 0;
  }
  ...
  public int compareTo(JTAddress o) {
